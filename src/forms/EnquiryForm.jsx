...
const TravelEnquiryForm = ({ onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await api.post('http://localhost:5000/api/v1/planYourJourney', formData);
...
>
      ...
      >
        ...
        <div className="p-8">
          <h2 className="text-3xl font-bold mb-4 text-center text-amber-700">Plan Your Journey</h2>
          ...
          {submitSuccess ? (
            <div className="text-center py-8">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Thank you for your enquiry!</h3>
              <p className="text-gray-600">We'll contact you soon about your trip to {formData.destination || 'your dream destination'}.</p>
            </div>
          ) : (
