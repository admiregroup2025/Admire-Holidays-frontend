    ...
    <div className="relative">
      ...
      <section className="relative max-w-7xl mx-auto px-4 sm:px-6 py-20 space-y-28 text-gray-800">
        ...
        <div className="text-center space-y-4">
          <h1 className="text-5xl font-bold text-teal-700">Welcome to Admire Holidays!</h1>
          <p className="max-w-3xl mx-auto text-lg text-gray-600">
            Admire Holidays is more than just a tour and travel company; we are your gateway to unforgettable experiences and remarkable journeys. With a legacy spanning over 10 years, we have established ourselves as a trusted name in the travel and tourism industry, committed to delivering excellence at every step of your journey.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-4">
            <div className="space-y-4">
              ...
              <p className="max-w-3xl mx-auto text-lg text-gray-600">
                With a legacy spanning over 10 years, Admire Holidays has become a trusted name in travel and tourism, committed to delivering excellence at every step.
              </p>
            </div>
            <h3 className="text-3xl font-semibold text-teal-700">Our Story</h3>
            <p className="text-lg text-gray-700">
              Our journey began with a simple yet profound mission: to help people explore the beauty of our world. Over the years, we have honed our expertise and expanded our services to cater to the diverse needs of travelers from all walks of life. Whether you seek adventure in the mountains, tranquility by the beach, or cultural immersion in vibrant cities, Admire Holidays is here to make your travel dreams a reality.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-4">
            <h3 className="text-3xl font-semibold text-teal-700">What Sets Us Apart</h3>
            <p className="text-lg text-gray-700">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="max-w-3xl mx-auto text-lg text-gray-700">
            Integrity, transparency, and customer satisfaction are at the heart of everything we do. We pride ourselves on our commitment to ethical business practices and our unwavering dedication to exceeding our clients' expectations. Your trust is our most valuable asset, and we strive to earn it through our actions, integrity, and dedication to delivering exceptional travel experiences.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-4">
            <h3 className="text-3xl font-semibold text-teal-700">Why Choose Admire Holidays</h3>
            <ul className="space-y-2 text-lg text-gray-700 list-disc list-inside">
              <li><strong>Experience:</strong> With over 10 years of experience in the industry, we have the knowledge and expertise to create unforgettable travel experiences tailored to your unique preferences and interests.</li>
              <li><strong>Personalized Service:</strong> We understand that no two travelers are alike, which is why we take the time to understand your needs and preferences to curate bespoke travel experiences that exceed your expectations.</li>
              <li><strong>Transparency:</strong> We believe in transparency and honesty in all our dealings. From pricing and itinerary details to terms and conditions, you can trust us to provide clear and upfront information every step of the way.</li>
