...
const StatsAndPartners = () => {
  // Keen Slider configuration for Hotel Alliances
  ...
  const hotels = [
    { name: 'Royal Heritage', logo: '/royalHeritageLogo.png' },
    { name: 'Pine View', logo: '/pineViewLogo.png' },
    { name: 'Pillican', logo: '/pillicanLogo.png' },
    { name: 'Reef Valley', logo: '/reefValley.png' },
    { name: 'Sangrilla', logo: '/sangrilla.png' },
    { name: 'Casa Montana', logo: '/casaMontana.png' },
    { name: 'Munnar Castle', logo: '/munnarCastle.png' },
    { name: 'Bamboo Dale', logo: '/bambooDale.png' },
    { name: 'Periyar Nest', logo: '/periyarNest.png' },
    { name: 'Grand Thekaddy', logo: '/grandThekaddy.png' },
  ];
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12 text-center">
            <h2 className="text-4xl font-extrabold text-gray-800 sm:text-5xl">Hotel Alliances</h2>
            <p className="mt-4 text-lg text-gray-600">Trusted partners offering unique and comfortable stays.</p>
          </div>
...
// MilestoneCard component (reused from previous example)
