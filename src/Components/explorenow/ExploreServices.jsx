...
import {
  MapPin, Users, Heart, Plane, Compass, Star, Calendar,
  Globe, Clock, Award
} from 'lucide-react';
        ...
        >
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="px-6 py-3 bg-white text-[#0D9488] rounded-full font-semibold hover:bg-[#A7F3D0] transition-all duration-200 shadow-lg hover:shadow-xl flex items-center justify-center">
